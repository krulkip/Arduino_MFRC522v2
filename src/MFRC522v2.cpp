...
switch (code) {
case StatusCode::STATUS_OK:				return F("Success.");
case StatusCode::STATUS_ERROR:			return F("Error in communication.");
case StatusCode::STATUS_COLLISION:		return F("Collision detected.");
case StatusCode::STATUS_TIMEOUT:		return F("Timeout in communication.");
case StatusCode::STATUS_NO_ROOM:		return F("A buffer is not big enough.");
case StatusCode::STATUS_INTERNAL_ERROR:	return F("Internal error in the code. Should not happen.");
case StatusCode::STATUS_INVALID:		return F("Invalid argument.");
case StatusCode::STATUS_CRC_WRONG:		return F("The CRC_A does not match.");
case StatusCode::STATUS_MIFARE_NACK:	return F("A MIFARE PICC responded with NAK.");
